...
subject.flatMap{ $0.message }
    ...
    .disposed(by: bag4)
let cuTe = User(message: BehaviorSubject(value: "Cu tý chào bạn"))
let cuTe = User(message: BehaviorSubject(value: "Cu tèo chào bạn"))
let subject1 = PublishSubject<User>()
subject1.onNext(cuTe)
cuTe.message.onNext("Cu Tý: There are 0 ball in the basket")
cuTe.message.onNext("Cu Tý: There are 1 ball in the basket")
cuTe.message.onNext("Cu Tý: There are 2 ball in the basket")
cuTe.message.onNext("Cu Tý: There are 3 ball in the basket")
cuTe.message.onNext("Cu Tý: There are 4 ball in the basket")
subject1.onNext(cuTeo)
cuTe.message.onNext("Cu Tý: Hello Cu Tèo")
cuTe.message.onNext("Cu Tèo: What chu doing?")
cuTe.message.onNext("Cu Tý: Counting balls")
cuTe.message.onNext("Cu Tý: I Have 4 Ball")
